...
router.post('/', asyncHandler(async (req, res) => {
  ...
  const { rows } = await query(
    ...
    [b.ticket_id, b.type, b.method || null, b.contact_info || null, b.international,
      b.scheduled_date || null, b.tracking_number || null, JSON.stringify(checklist), b.notes || null],
  );
